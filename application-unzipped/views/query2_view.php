...
<h2>Total Current Employees per Company</h2>
<div align='center'>
<?php
	...
	$this->db->query("create temporary table temp as (select supplier.SupplierName AS 'Supplier',COUNT(*) AS 'Total Current Employees'
	from driveridcard, supplier 
	where supplier.SupplierID= driveridcard.CardEmp AND State='Valid'
