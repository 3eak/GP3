...
<?php
	...
	$this->db->query("create temporary table temp as (select VenueStadiumName AS 'Venue Stadium Name',COUNT(*) AS 'Total Deliveries'
	from delivery, venue 
	where venue.VenueID=delivery.DeliveryVenue
