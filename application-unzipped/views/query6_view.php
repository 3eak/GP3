...
<h2>All deliveries by Suppliers</h2>
<div align='center'>
<?php
	...
	$this->db->query("create temporary table temp as (select SupplierName AS 'Supplier Name', COUNT(*) AS 'Total Deliveries'
	from delivery, supplier
	where supplier.SupplierID=delivery.DeliverySupplier
	group by DeliverySupplier)");
