...
<?php
	...
	$this->db->query("create temporary table temp as (select driver.DriverName AS 'Driver',COUNT(*) AS 'Total Deliveries'
	from driver, delivery 
	where driver.DriverID= delivery.DeliveryDriver 
