...
<h2>Total Vehicles per Company</h2>
<div align='center'>
<?php
	...
	$this->db->query("create temporary table temp as (select supplier.SupplierName AS 'Supplier',COUNT(*) AS 'Total Current Vehicles'
	from vehicle, supplier 
	where supplier.SupplierID= vehicle.VehicleSupplier
